...
- `libtorrent` 目前已有主 crate API、adapter 包、可编译的 native CXX bridge、torrent-file metadata 提取、完整控制入口、fast-resume 状态闭环和本地 peer-wire 端到端验证；下一步是做 CLI / release 打包策略
